    ...
    <div className="px-3 sm:px-4 py-6 sm:py-8 max-w-2xl mx-auto">
      ...
      >
        ...
        <p className="text-white/70 text-sm leading-relaxed">
          ...
          🤝 שיתוף פעולה עם חבר = 25 מטבעות<br />
          💬 פעילות בפיד (לייקים ותגובות) = מעורבות בקהילה<br />
          🔥 רצף כניסות יומי = 10 מטבעות ביום הראשון, +10 כל יום (20, 30, 40...)<br />
          📈 רווחי השקעות<br />
          ✅ משימות בפרופיל = עד 300 מטבעות<br />
          👤 השלמת פרטי פרופיל = 70 מטבעות<br />
          <span className="text-red-300 font-bold mt-2 block">⚠️ שים לב: כל יום יש אינפלציה (3%) על העובר ושב, מס הכנסה (2%) על כל השווי, וריבית אשראי (10%) על יתרת חובה!</span>
        </p>
      </motion.div>
