        ...
        <Card className="bg-gradient-to-br from-indigo-900/95 via-purple-900/95 to-indigo-900/95 backdrop-blur-md border-2 border-purple-400/60 shadow-2xl">
          <CardContent className="p-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                { image: "https://media.base44.com/images/public/68e295dfd1c97e3c8c54140e/da0342d35_image.png", name: "Razer Basilisk V3 X", desc: "עכבר גיימינג אלחוטי", price: "250,000", isCoins: true },
